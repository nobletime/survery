var surveys = [
  ...
  {
    id: "1",
    name: "C-GASP Level 1 Screener B",
    json:{
      ...
      "pages": [
       ...
       },
       {
        ...
        "elements": [
         {
          "type": "matrix",
          "name": "secondary1",
          "visibleIf": "{main_questions.Row 1} = 'Column 1'",
        ...
        "visibleIf": "{main_questions.Row 1} = 'Column 1' or {main_questions.Row 2} = 'Column 1' or {main_questions.Row 3} = 'Column 1' or {main_questions.Row 4} = 'Column 1' or {main_questions.Row 5} = 'Column 1'",
        ...
        "elements": [
         {
          "type": "matrix",
          "name": "secondary2",
          "visibleIf": "{main_questions.Row 2} = 'Column 1'",
        ...
        "elements": [
         {
          "type": "matrix",
          "name": "secondary3",
          "visibleIf": "{main_questions.Row 3} = 'Column 1'",
        ...
        "elements": [
         {
          "type": "matrix",
          "name": "secondary4",
          "visibleIf": "{main_questions.Row 4} = 'Column 1'",
        ...
        "elements": [
         {
          "type": "matrix",
          "name": "secondary5",
          "visibleIf": "{main_questions.Row 5} = 'Column 1'",
